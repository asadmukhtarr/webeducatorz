					...
					<div class="row align-items-center justify-content-between">
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="lmp_caption">
								...
								<p>Skillnsiderz is providing in house and physical traning's to make future bright. we have diffrent traning programs accoding to your futuer goals. we are hare to train 
you qualty traning's of information techonology gields and we will also train
that how can you utilize these skills in your practical filds.</p>
								<div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
									<div class="d-flex align-items-center">
									  ...
									  <h6 class="mb-0 ml-3">Physical , Online & Recording Lectures</h6>
									</div>
								</div>
								<div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
									<div class="d-flex align-items-center">
									  ...
									  <h6 class="mb-0 ml-3">Complete Practical Training</h6>
									</div>
								</div>
								<div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
									<div class="d-flex align-items-center">
								...
								<div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
									<div class="d-flex align-items-center">
									  ...
									  <h6 class="mb-0 ml-3">Job Guarantee</h6>
									</div>
								</div>
								<div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
									<div class="d-flex align-items-center">
									  ...
									  <h6 class="mb-0 ml-3">Internship</h6>
									</div>
								</div>
								<div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
									<div class="d-flex align-items-center">
									  ...
									  <h6 class="mb-0 ml-3">Freelancing Training</h6>
									</div>
								</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-8">
							<div class="sec-heading center">
								...
								<p>our 90% focus is in practical work to make you exeprts we will not provide you any notes for read and learn it. we will teach you practically each and everything. we are offring courses based on information technology latest and tranding teshniques.
</p>
							</div>
						</div>
					</div>
