        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                    ...
                    <li><a href="#">{{ ucfirst($sevent->category->category) }}</a></li>
                </ul>
                <div class="section-heading">
                    <h2 class="section__title">{{ ucfirst($sevent->title) }}</h2>
                    <p class="section__desc pt-2 lh-30">{{ ucfirst($sevent->meta) }}</p>
                </div>
                <!-- end section-heading -->
                <div class="d-flex flex-wrap align-items-center">
                    <p class="pr-3 d-flex align-items-center">
                        ...
                        Duration: {{ $sevent->start }} - {{ $sevent->end }}
                    </p>
                    <p class="pr-3 d-flex align-items-center">
                        ...
                        Type: </b>{{ $sevent->Type }} - <b>Date: </b>{{ $sevent->date }} 
                    </p>
                </div><!-- end d-flex -->
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="https://management.webeducatorz.com/storage/app/public/{{ $sevent->thumbnail }}" data-src="https://management.webeducatorz.com/storage/app/public/{{ $sevent->thumbnail }}" alt="course-img" class="w-100 rounded lazy">
                                </a>
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="preview-course-incentives">
                                    <h3 class="card-title fs-18 pb-2">Workshop Information</h3>
                                    <ul class="generic-list-item pb-3">
                                        <li><i class="la la-file-text mr-2 text-color"></i>{{ ucfirst($sevent->title) }}</li>
                                        <li><i class="la la-play-circle-o mr-2 text-color"></i>Duration: {{ $sevent->start }} - {{ $sevent->end }}</li>
                                        <li><i class="la la-file mr-2 text-color"></i>Type: {{ $sevent->type }}</li>
                                        <li><i class="la la-code mr-2 text-color"></i>Date: {{ $sevent->date }}</li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="cta-btn-box text-right">
                    <a href="{{ route('teacher_admission')}}" class="btn theme-btn">Become an Instructor <i class="la la-arrow-right icon ml-1"></i> </a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
