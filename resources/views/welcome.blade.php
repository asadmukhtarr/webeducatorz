            ...
            <div class="container">
                <div class="hero-content">
                    <div class="section-heading">
                        ...
                        <p class="section__desc text-white pb-4">One of the largest institute in the Pakistan where we offers a selection of online courses.
                            <br>Learn about the innovations, technology and latest platforms.
                        </p>
                    </div><!-- end section-heading -->
                    <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1">
                        <a href="{{ route('apply.online') }}" class="btn theme-btn mr-4 mb-4">Join with Us <i class="la la-arrow-right icon ml-1"></i></a>
        ...
        <div class="hero-slider-item hero-bg-2">
            <div class="container">
                <div class="hero-content text-center">
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-65 lh-80 pb-3">Join Webeducatorz & Get <br> Your Free Courses!</h2>
                        <p class="section__desc text-white pb-4">One of the largest institute in the Pakistan where we offers a selection of online courses.
                            <br>Learn about the innovations, technology and latest platforms.
                        </p>
                    </div><!-- end section-heading -->
                    <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-center">
                        <a href="{{ route('apply.online') }}" class="btn theme-btn mr-4 mb-4">Get Started <i class="la la-arrow-right icon ml-1"></i></a>
                        <a href="#" class="btn-text video-play-btn mb-4" data-fancybox data-src="https://www.youtube.com/watch?v=cRXm1p-CNyk">
                            Watch Preview<i class="la la-play icon-btn ml-2"></i>
                        </a>
                    </div><!-- end hero-btn-box -->
            ...
            <div class="container">
                <div class="hero-content text-right">
                    ...
                    <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-end">
                        ...
                        <a href="{{ route('apply.online') }}" class="btn theme-btn mb-4"><i class="la la-arrow-left icon mr-1"></i>Get Enrolled </a>
                    </div><!-- end hero-btn-box -->
                </div><!-- end hero-content -->
            </div><!-- container -->
        </div><!-- end hero-slider-item -->
        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Learn about the innovations, technology and latest platforms.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
            ...
            <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
               ...
               <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="{{ route('course',$course->slug) }}">{{ ucfirst($course->category->category) }}</a></p>
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <h4 class="counter__title counter text-color-2">100</h4>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <h4 class="counter__title counter text-color-3">1000</h4>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <h4 class="counter__title counter text-color-4">500</h4>
    ...
    <div class="container">
        <div class="cta-content-wrap text-center">
            ...
            <div class="cat-btn-box mt-28px">
                <a href="{{ route('courses') }}" class="btn theme-btn">Get Started <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
        ...
        <div class="testimonial-carousel owl-action-styled">
            ...
            <div class="card card-item">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Thank you webeducatorz! You've renewed my passion for
            ...
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Benefits of Learning With Webeducatorz</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc">
                            One of the largest institute in the Pakistan where we offers a selection of online courses.
                            <br>Learn about the innovations, technology and latest platforms.
                        </p>
                    </div><!-- end section-heading -->
                    <div class="row pt-4 pb-3">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">100 Courses</h4>
            ...
            <div class="col-lg-6 ml-auto">
                <div class="register-content">
                    <div class="section-heading">
                        ...
                        <span class="section-divider"></span>
                        <p class="section__desc">Education is the process of acquiring the body of knowledge and skills that people are expected have in your society. A education develops a critical thought process in addition to learning.One of the largest institute in the Pakistan where we offers a selection of online courses.
                            <br>Learn about the innovations, technology and latest platforms.</p>
                    </div><!-- end section-heading -->
...
<section class="client-logo-area section-padding position-relative overflow-hidden text-center">
    ...
    <div class="container">
        <div class="section-heading">
            ...
            <h2 class="section__title">Top companies choose <a href="for-business.html" class="text-color hover-underline">Webeducatorz for Business</a> to build
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Teach what you love. Webeducatorz gives you the tools to create a course.</p>
                        <div class="btn-box mt-20px">
                            <a href="{{route('teacher_admission')}}" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="la la-user mr-1"></i>Start Teaching</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
