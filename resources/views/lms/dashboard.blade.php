        ...
        <div class="dashboard-content-wrap">
            ...
            <div class="container-fluid">
                            ...
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        ...
                                        <h5 class="card-title pt-2 fs-26">{{ $b::where('status', 1)->count() }}</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                            ...
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        ...
                                        <h5 class="card-title pt-2 fs-26">{{ $b::where('status', 2)->count() }}</h5>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                        ...
                        <div class="card card-item dashboard-info-card">
                            <div class="card-body d-flex align-items-center">
                                <div class="icon-element flex-shrink-0 bg-3 text-white">
                                    <svg class="svg-icon-color-white" width="40" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        viewBox="0 0 478.856 478.856" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path
                ...
                <div class="row align-items-center dashboard-copyright-content pb-4">
                    <div class="col-lg-6">
                        <p class="copy-desc">&copy; 2022 webeducatorz. All Rights Reserved. by <a
                                href="https://webeducatorz.com/">webeducatorz</a></p>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
