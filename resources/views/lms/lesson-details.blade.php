                ...
                <div class="main-menu-content d-flex align-items-center">
                    ...
                    <div class="menu-wrapper ml-auto">
                        <div class="nav-right-button d-flex align-items-center">
                            <a href="{{route('dashboard')}}" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-26 text-white mr-2" data-toggle="modal" data-target="#ratingModal"><i class="la la-star mr-1"></i> Back to Home</a>
