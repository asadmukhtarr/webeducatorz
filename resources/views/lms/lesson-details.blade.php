        ...
        <div class="container-fluid">
            <div class="main-menu-content d-flex align-items-center">
                <div class="course-dashboard-header-title pl-4">
                    <a href="#" class="text-white fs-15"><i style="padding-right: 8px;" class="fa-duotone fa-house"></i>{{$course->title}}</a>
                        ...
                        <div class="accordion generic-accordion generic--accordion" id="accordionCourseExample">
                            <div class="card">
                                ...
                                <div class="card-header" id="headingOne">
                                    ...
                                    <span class="fs-15"><i style="padding-right: 8px;" class="fa-solid fa-circle-play"></i>{{$lecture->title}}</span>
                                    </button>
                                </div><!-- end card-header -->
                                @endforeach
                            </div><!-- end card -->
