    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    <form action="{{ route('accounts.updatecategory', $expensecategory->id) }}" method="post">
                        @csrf
                        <td colspan="2">
                        ...
                        <td>
                        <button type="submit" class="btn btn-danger"><b> <i class="fa fa-save"></i> Update</b></button>
                        </td>
                    </form>
                </tr>
