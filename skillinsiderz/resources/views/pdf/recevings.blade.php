...
<body style="padding:1%;">
    ...
    <div style="min-height:690px; border:1px solid #ddd;">
        ...
        <tr>
                ...
                @foreach($fees as $fee)
                    <tr>
                        <td>{{ $fee->fee->enrollment->stuid }}</td>
                        <td>{{ ucfirst($fee->student->name) }}</td>
                        <td>{{ ucfirst($fee->student->phone) }}</td>
                        <td>{{ ucfirst($fee->badge->code) }}</td>
                        <td>{{ ucfirst($fee->last_day) }}</td>
                        <td>{{ ucfirst($fee->method) }}</td>
                        <td>{{ ucfirst($fee->amount) }} PKR</td>
                    </tr>
                @endforeach
